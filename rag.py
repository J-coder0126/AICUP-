...
txt_path=os.listdir(r"/mnt/disk4/guz/aicup2025/RAG/task1/")
#idsd=os.listdir(r"/mnt/disk4/guz/aicup2025/RAG/task1/") #all

sadds="gpu23"  #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

save_path="/mnt/disk4/guz/aicup2025/out_ans/result_{}_0608.txt".format(sadds)   #gpu用哪個記得˙改名
save_path_think="/mnt/disk4/guz/aicup2025/out_ans/result_think_{}_0608.txt".format(sadds) 
gpu01234num=int(len(txt_path)*0.45)
if sadds=="gpu01":
    print(sadds)
    #idsd=txt_path[:5] ##gpu01 5筆
    idsd=txt_path[:gpu01234num] ##gpu01
elif sadds=="gpu23":
    print(sadds)
    idsd=txt_path[gpu01234num:2*gpu01234num] ##gpu23
elif sadds=="gpu45":
    print(sadds)
    idsd=txt_path[gpu01234num*2:]  ##gpu45
else:
    print("gpu錯誤")

random.seed(42)

#local=r"F:\AI_CUP\code_AI_CUP\AI_CUP_task1_code\result_val\task2_json_val"
alocal=r"/mnt/disk4/guz/aicup2025/RAG/training_01_label/" #traindata1_task1_task2_label
blocal=r"/mnt/disk4/guz/aicup2025/RAG/training_02_label/" #traindata2_task1_task2_label
clocal=r"/mnt/disk4/guz/aicup2025/RAG/training_val_label/"
...
def senword_to(text2,output):
    ...
    #print(idx)
    #print("====")
    #print("type of text2[idx]:", type(text2[idx]))
    #print("content:", text2[idx])
    i=text2[idx]['word']
    #print("i===")
    #print(i)
    #print("===")
    bbd1+="text:"+i+"\nsensetive:\n"
    #print(type(text2))
    #print(output['ids'][0][0])
    #print(text2[output['ids'][0][0]])
...
class chroma():
    def __init__(self,word,toto,ids,word2,toto2,ids2,word3,toto3,ids3):
        ...
        self.collection3 = chroma_client.create_collection(name="my_collection3")
        self.collection.add(
            documents=word,
            metadatas=toto,
            ids=ids
    ...
    def check(self,query,n_results=1):
        ...
        results3=self.collection3.query(
        query_texts=[query],
        n_results=n_results
        )
...
toto3,word3=chroma_data(text3,idss3)


# In[9]:


y=chroma(word1,toto1,idss,word2,toto2,idss2,word3,toto3,idss3)
...
def test_data(x1):
    with open(r"/mnt/disk4/guz/aicup2025/RAG/task1/{}".format(x1),"r",encoding="utf-8") as f:
        x=f.read()
    f.close()
    return x
...
# In[ ]:
model_name = "/mnt/disk3/xinyou/model_LLM/Qwen3-32B/"# <-- 替換為你的模型名稱
...
for i in tqdm(idsd):
    ...
    prompt_text  = tokenizer.apply_chat_template(
        messages,
        tokenize=False,
        add_generation_prompt=True,  # 讓模型接續生成
        enable_thinking=True        # 如果模型有思考模式
    )
    ...
    **model_inputs,
    ...
    with open(save_path_think, "w", encoding="utf-8") as f:
